...
```{r drilldown-plot1a, fig.cap = "Drilldown from broad to narrow neurocognitive domains.", fig.width = 12, fig.height = 8, fig.retina = 3, out.width = '100%'}
data <- neurocog
neuro_domain <- "Neuropsychological Test Scores"
theme <- theme_merge
source("drilldown_pass_timed_verbal.R")
plot1 <-
  drilldown2(
    data = data,
    patient = patient,
